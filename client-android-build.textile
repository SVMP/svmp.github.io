...
Gradle build files are also included in addition to Ant. Gradle 1.10, 1.11, or 1.12 is required. To build the application using gradle:
...
h2. Building with Server Certificate Pinning
